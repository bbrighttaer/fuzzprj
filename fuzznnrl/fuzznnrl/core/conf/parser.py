...
from fuzznnrl.core.conf.gft import CreateFromDocument as createGFT
from fuzznnrl.core.conf.linvars import CreateFromDocument as createLinvars
from fuzznnrl.core.fuzzy.gfs import GeneticFuzzySystem
from fuzznnrl.core.reg.registry import Registry
