...
# Generated 2018-06-03 12:57:04.947699 by PyXB version 1.2.6 using Python 3.6.5.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:8f651d76-66ea-11e8-a062-1c3e846a7922')
...
class STD_ANON(pyxb.binding.basis.STD_list):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 13, 8)
    _Documentation = None
...
class PartialChromOffsets(pyxb.binding.basis.STD_list):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 46, 1)
    _Documentation = None
...
class outputTargetType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 68, 1)
    _Documentation = None
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 7, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __fuzzyInferenceSystem = pyxb.binding.content.ElementDeclaration(
        ...
        pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 9, 4), )
    ...
    __rootInfSystem = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'rootInfSystem'),
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 10, 5)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '../res/gftlv0.1.1.xsd', 39, 6)
    __name._UseLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd',
                                                      39, 6)
...
class CTD_ANON_2(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 24, 8)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_3(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 27,
                                               11)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class OutputVariableTerm(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 49, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '../res/gftlv0.1.1.xsd', 66, 2)
    __type._UseLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd',
                                                      66, 2)
...
class CTD_ANON_4(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 52, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element successOpTitle uses Python identifier successOpTitle
    __successOpTitle = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'successOpTitle'),
                                                               'successOpTitle',
    ...
    __code = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'code'), 'code',
                                               '__AbsentNamespace0_CTD_ANON_4_code', pyxb.binding.datatypes.integer,
                                               required=True)
    __code._DeclarationLocation = pyxb.utils.utility.Location(
        '../res/gftlv0.1.1.xsd', 62, 5)
    __code._UseLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd',
                                                      62, 5)
...
class varInfo(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 74, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_5(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../res/gftlv0.1.1.xsd', 56, 7)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Attribute targetType uses Python identifier targetType
    __targetType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'targetType'), 'targetType',
                                                     '__AbsentNamespace0_CTD_ANON_5_targetType',
                                                     _module_typeBindings.outputTargetType, required=True)
    __targetType._DeclarationLocation = pyxb.utils.utility.Location(
        '../res/gftlv0.1.1.xsd', 57, 8)
