# project: fuzzprj
# Copyright (C) 7/9/18 - 9:48 PM
# Author: bbrighttaer
# original code: https://raw.githubusercontent.com/xuemei-ye/maddpg-mpe/master/randomProcess.py
...
# p = OrnsteinUhlenbeckProcess(theta=.1)
# for i in range(1000):
#     print("t = {}, p = {}".format(i, p.sample()))
